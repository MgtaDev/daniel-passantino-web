...
const Blog = () => {
  return (
    ...
    <div class="max-w-[75rem] px-4 sm:px-6 lg:px-8 mx-auto">
      <div class="grid lg:grid-cols-7  gap-y-8 lg:gap-y-0 lg:gap-x-6">

        {/* <!-- Content --> */}
        <div class="lg:col-span-4 ml-14">
        ...
        {/* <!-- Sidebar --> */}
        <div class="lg:col-span-1 lg:mr-32 lg:right-0 lg:top-0 lg:fixed lg:w-1/3 lg:h-[90vh] mt-24 mr-4 rounded-lg lg:bg-gradient-to-r lg:from-gray-50 lg:via-transparent lg:to-transparent dark:from-neutral-800 overflow-y-auto">
