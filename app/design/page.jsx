...
<div class="overflow-hidden lg:mx-24">
      ...
      <form>
        <div class="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-gray-900/20">
          ...
          <div class="whitespace-nowrap pt-2 sm:pt-0 grid sm:block">
            <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-gradient-to-r from-purple-400 via-[#7d5ed7] to-[#683fe4] text-white focus:outline-none disabled:opacity-50 disabled:pointer-events-none" href="#">
             Contactame
            </a>
          </div>
        </div>
  ...
  <div class=" px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div class="grid lg:grid-cols-1 gap-12">
      <div class="group sm:flex rounded-xl focus:outline-none">
