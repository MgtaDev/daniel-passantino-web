        ...
        <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
          <div class="text-center">
            ...
            <h3 class="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-5xl lg:mx-8 lg:leading-tight dark:text-neutral-200">
              Conoce algunas de <span class="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-[#7d5ed7] to-[#683fe4]"> Mis creaciones</span>
            </h3>
          </div>
