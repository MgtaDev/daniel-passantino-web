  ...
  <div class="grid sm:grid-cols-2 sm:items-center gap-8">
    <div class="sm:order-1">
      ...
      <h2 class="text-2xl font-bold md:text-3xl lg:text-4xl text-center lg:leading-tight xl:text-5xl xl:leading-tight text-gray-800 dark:text-neutral-200">
        ...
        Gestionar tus redes sociales a través de la <span className='bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-[#7d5ed7] to-[#683fe4]'>Fotografía</span>
        </a>
      </h2>

      <p class="mt-3 text-lg text-gray-800 text-center dark:text-neutral-400">La gestión de las redes sociales de una empresa debe pasar necesariamente por la fotografía. Mostrarle a tu audiencia lo que haces es la mejor manera de dar en el clavo.

Realizo fotos tuyas o de tus productos así como publicaciones en tus redes sociales.

Utilizo la herramienta profesional Photoshop para realizar recortes o montajes.</p>
      <div class="mt-5 text-center">
        <a class="inline-flex text-center items-center gap-x-1.5 bg-clip-text text-transparent bg-gradient-to-r from-white via-[#7d5ed7] to-[#683fe4] decoration-2 hover:underline focus:outline-none focus:underline font-medium" href="#">
          Ver mas
          <svg class="shrink-0 size-4 text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
        </a>
      </div>
    </div>
...
<div class=" lg:mx-20 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div class="grid sm:grid-cols-2 sm:items-center gap-8">
    ...
    <div class="sm:order-2">
      ...
      <h2 class="text-2xl font-bold md:text-3xl lg:text-4xl text-center lg:leading-tight xl:text-5xl xl:leading-tight text-gray-800 dark:text-neutral-200">
        <a class="hover:text-blue-600 focus:outline-none  focus:text-blue-600 dark:text-neutral-300 dark:hover:text-white dark:focus:text-white" href="#">
        <span className='bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-[#7d5ed7] to-[#683fe4]'>El video,</span> el medio de distribucion ideal para las empresas
        </a>
      </h2>

      <p class="mt-3 text-lg text-gray-800 text-center dark:text-neutral-400">Produzco videos que pueden usarse para anuncios, TikTok, Reels, etc. La edición se realiza en Adobe Premiere Pro, Filmora y Capcut, que es una herramienta profesional.
</p>
      <div class="mt-5 text-center">
      <a class="inline-flex text-center items-center gap-x-1.5 bg-clip-text text-transparent bg-gradient-to-r from-white via-[#7d5ed7] to-[#683fe4] decoration-2 hover:underline focus:outline-none focus:underline font-medium" href="#">
          Ver mas
