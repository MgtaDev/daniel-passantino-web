  ...
  <div class="overflow-hidden">
        ...
        <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
          ...
          <div class="sm:flex sm:justify-center sm:items-center text-center sm:text-start">
            ...
            <div class="pt-5 sm:pt-0 sm:ps-5">
              <div class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Daniel Passantino</div>
    ...
    <div class="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
      <div>
        ...
        <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-[#7d5ed7] to-[#683fe4]">99.95%</p>
      ...
      <div>
        ...
        <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-[#7d5ed7] to-[#683fe4]">2,000+</p>
        <p class="mt-1 text-gray-400">partner with Preline</p>
      </div>

      <div>
        <h4 class="text-lg sm:text-xl font-semibold text-white">Happy customer</h4>
        <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-[#7d5ed7] to-[#683fe4]">85%</p>
