...
<div class="overflow-hidden lg:mx-20 bg-gray-800 dark:bg-neutral-950">
  <div class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div class="flex text-center justify-center  mb-6 sm:mb-10 md:mb-16">
      <h2 class="text-2xl text-center flex mx-60 justify-center sm:text-3xl lg:text-5xl text-white font-semibold">
